...
### Выполнение 
#### ([перейти к скрипту](https://github.com/Ask1509/Linux-Seminar4-Bash/blob/main/delfiletodir.sh))
...
### Выполнение
#### ([перейти к скрипту](https://github.com/Ask1509/Linux-Seminar4-Bash/blob/main/ownersort.sh))
